...
import amrabed.android.release.evaluation.databinding.GuideItemBinding
...
class GuideSection : Fragment() {
    ...
    inner class Adapter(val list: Array<String>) : RecyclerView.Adapter<Adapter.ViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
            ViewHolder(GuideItemBinding.inflate(LayoutInflater.from(context), parent, false))
...
class EntryFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, parent: ViewGroup?, state: Bundle?): View =
        inflater.inflate(R.layout.guide_container, parent, false).apply {
    ...
    inner class PagerAdapter : FragmentStateAdapter(requireActivity()) {
        ...
        override fun createFragment(position: Int) = Page().apply {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.guide_entry, container, false).apply {
            findViewById<TextView>(R.id.text).text =
                readText(resources.openRawResource(ENTRIES[index]))
        }
    }
...
private val ENTRIES = intArrayOf(
    R.raw.wakeup, R.raw.brush, R.raw.night, R.raw.fasting,
