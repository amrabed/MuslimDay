 ...
 */
object DailyReminder : BaseReminder {
    ...
    private fun schedule(context: Context) {
        ...
        val intent = PendingIntent.getBroadcast(context, 0, Intent(context, Notifier::class.java), PendingIntent.FLAG_UPDATE_CURRENT)
    ...
    private fun cancel(context: Context) {
        ...
        val intent = PendingIntent.getBroadcast(context, 0, Intent(context, Notifier::class.java), PendingIntent.FLAG_NO_CREATE)
